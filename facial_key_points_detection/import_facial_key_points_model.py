...
def import_model(custom_objects: dict, yadisk_url_download: str = os.getenv('YANDEX_DISK_DOWNLOAD'), yadisk_token: str = os.getenv('YANDEX_DISK_API_TOKEN'), yadisk_path: str = os.getenv('SMALL_FACIAL_KEY_POINTS_MODEL_PATH'), path: str = 'facial_key_points.keras', save_model: bool = False):
    """
