...
def test(image_path1, image_path2):
    ...
    face1 = image_path1[coordinates1[0][1]:coordinates1[0][1]+coordinates1[0][3]+1, coordinates1[0][0]:coordinates1[0][0]+coordinates1[0][2]+1]
    face2 = image_path1[coordinates2[0][1]:coordinates2[0][1]+coordinates2[0][3]+1, coordinates2[0][0]:coordinates2[0][0]+coordinates2[0][2]+1]
