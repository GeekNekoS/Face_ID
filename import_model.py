...
def import_model_from_yadisk(yadisk_url_download: str, yadisk_token: str, yadisk_path: str, path: str, custom_objects: dict = None, save_model: bool = False):
    """
    ...
    :return: CNN model
    """
    import_from_yadisk(yadisk_url_download, yadisk_token, yadisk_path, path)
